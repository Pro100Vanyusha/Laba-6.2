...
namespace Laba_6._2
{
    ...
    class Person : Human, IComparable<Person>
    {
        public string surname { get; set; }
        public string initials { get; set; }
        public short year { get; set; }
        public double salary { get; set; }
        string Human.surname { get; set; }
        string Human.initials { get; set; }
        short Human.year { get; set; }
        double Human.salary { get; set; }
    ...
    class CollectionType
    {
        ...
        public void Output()
        {
            Console.WriteLine(String.Format("{0,20}|{1,20}|{2,20}|{3,20}", "Surname ", "Initials ", "Date of birth ", "Salary"));
    ...
    class Program
    {
        ...
        {
            Person sgn1 = new Person("Peters", "G.P.", 1997, 1900.90);
            Person sgn2 = new Person("Jackson", "M.F.", 1994, 1850.50);
            Person sgn3 = new Person("Williams", "М.С.", 2001, 1100.30);
            ...
            Person sgn5 = new Person("Peters", "G.P.", 1997, 1900.90);
            Person sgn6 = new Person("Jackson", "M.F.", 1994, 1850.50);
            Person sgn7 = new Person("Williams", "М.С.", 2001, 1100.30);
            ...
            CollectionType[] collections = {
                new CollectionType("Peters", "G.P.", 1997, 1900.90),
                new CollectionType("Jackson", "M.F.", 1994, 1850.50),
                new CollectionType("Williams", "М.С.", 2001, 1100.30)
            };
